# CoreUI Free React vendor Template [![Tweet](https://img.shields.io/twitter/url/http/shields.io.svg?style=social&logo=twitter)](https://twitter.com/intent/tweet?text=CoreUI%20-%20Free%React%204%20vendor%20Template%20&url=https://coreui.io&hashtags=bootstrap,vendor,template,dashboard,panel,free,angular,react,vue)
...
[![Bootstrap vendor Template](https://assets.coreui.io/products/coreui-free-bootstrap-vendor-template-light-dark.webp)](https://coreui.io/product/free-react-vendor-template/)
...
* [CoreUI PRO React vendor Templates](#coreui-pro-react-vendor-templates)
...
* [CoreUI Free Bootstrap vendor Template](https://github.com/coreui/coreui-free-bootstrap-vendor-template)
* [CoreUI Free Angular vendor Template](https://github.com/coreui/coreui-free-angular-vendor-template)
* [CoreUI Free React.js vendor Template (Vite)](https://github.com/coreui/coreui-free-react-vendor-template)
* [CoreUI Free React.js vendor Template (Create React App)](https://github.com/coreui/coreui-free-react-vendor-template-cra)
* [CoreUI Free Vue.js vendor Template](https://github.com/coreui/coreui-free-vue-vendor-template)

## CoreUI PRO

* 💪  [CoreUI PRO Angular vendor Template](https://coreui.io/product/angular-dashboard-template/)
* 💪  [CoreUI PRO Bootstrap vendor Template](https://coreui.io/product/bootstrap-dashboard-template/)
* 💪  [CoreUI PRO Next.js vendor Template](https://coreui.io/product/next-js-dashboard-template/)
* 💪  [CoreUI PRO React vendor Template](https://coreui.io/product/react-dashboard-template/)
* 💪  [CoreUI PRO Vue vendor Template](https://coreui.io/product/vue-dashboard-template/)

## CoreUI PRO React vendor Templates

| Default Theme | Light Theme |
| --- | --- |
| [![CoreUI PRO React vendor Template](https://coreui.io/images/templates/coreui_pro_default_light_dark.webp)](https://coreui.io/product/react-dashboard-template/?theme=default) | [![CoreUI PRO React vendor Template](https://coreui.io/images/templates/coreui_pro_light_light_dark.webp)](https://coreui.io/product/react-dashboard-template/?theme=light)|

| Modern Theme | Bright Theme |
| --- | --- |
| [![CoreUI PRO React vendor Template](https://coreui.io/images/templates/coreui_pro_default_v3_light_dark.webp)](https://coreui.io/product/react-dashboard-template/?theme=modern) | [![CoreUI PRO React vendor Template](https://coreui.io/images/templates/coreui_pro_light_v3_light_dark.webp)](https://coreui.io/product/react-dashboard-template/?theme=bright)|

## Quick Start

- [Download the latest release](https://github.com/coreui/coreui-free-react-vendor-template/archive/refs/heads/main.zip)
- Clone the repo: `git clone https://github.com/coreui/coreui-free-react-vendor-template.git`
...
```
coreui-free-react-vendor-template
├── public/          # static files
│   ├── favicon.ico
│   └── manifest.json
│
...
The documentation for the CoreUI vendor Template is hosted at our website [CoreUI for React](https://coreui.io/react/docs/templates/installation/)

## Components

CoreUI React.js vendor Templates are built on top of CoreUI and CoreUI PRO UI components libraries, including all of these components.
...
For transparency into our release cycle and in striving to maintain backward compatibility, CoreUI Free vendor Template is maintained under [the Semantic Versioning guidelines](http://semver.org/).

See [the Releases section of our project](https://github.com/coreui/coreui-free-react-vendor-template/releases) for changelogs for each release version.
...
CoreUI is an MIT-licensed open source project and is completely free to use. However, the amount of effort needed to maintain and develop new features for the project is not sustainable without proper financial backing. You can support development by buying the [CoreUI PRO](https://coreui.io/pricing/?framework=react&src=github-coreui-free-react-vendor-template) or by becoming a sponsor via [Open Collective](https://opencollective.com/coreui/).

## Copyright and License

copyright 2025 creativeLabs Łukasz Holeczek.   

Code released under [the MIT license](https://github.com/coreui/coreui-free-react-vendor-template/blob/main/LICENSE).